...
![[docs/Attachments/Methodology/1. Enumeration/0. Initial Recon/3. General methodology/Content Discovery/Automation workflow/Automation Scripts and Oneliners/XSS automation/XSS Cookie Theft/{{notename}}-202605011506.png]]