...
- [ ] For post exploitation dump all hashes using [[Methodology/2. Privilege Escalation/Windows Privesc/Active Directory Methdology/Attacks/Pass The Hash/Remote Hashdump & Bruteforce Hashes]]
- [ ] Check UDP ports. 
