...
![unnamed_5a4c6b2928424c909d275090682afd2f](docs/Attachments/Methodology/4.%20Client%20Side%20Attacks/smb%20mslink%20file/{{notename}}-202605011506.png)

(you can do with responder instead of smbserver too)
![unnamed_f0adb844498f420fa6a7d898d1fc458c](docs/Attachments/Methodology/4.%20Client%20Side%20Attacks/smb%20mslink%20file/{{notename}}-202605011506-1.png)

And bam, it triggeres. Next up is trying to crack this netntlmv2 hash:

![unnamed_160e27814f054b089b54724c871daf8c](docs/Attachments/Methodology/4.%20Client%20Side%20Attacks/smb%20mslink%20file/{{notename}}-202605011506-2.png)
