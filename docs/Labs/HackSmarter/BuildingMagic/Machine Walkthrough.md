...
#HackSmarter #ShareThePain #Machine_Walkthrough #Rooted

* * *

<br>

# ShareThePain Machine Walkthrough
...
Now that we have a username and known password we will add these to our known\_users file and do enumeration again with maelstrom.
...
Now we need to add this user to our known\_users file and then mark this user as owed in the database.
...
> \[!important\] enable\_xp\_cmdshell
