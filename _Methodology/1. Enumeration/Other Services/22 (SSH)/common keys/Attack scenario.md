...
![unnamed_b9f7ad68fdb24a01ab735be2e461e441](docs/Attachments/_Methodology/1.%20Enumeration/Other%20Services/22%20(SSH)/common%20keys/Attack%20scenario/{{notename}}-202605011742.png)
I could now login normally!
![unnamed_1decf4276d4c4a7c995a89486d93a719](docs/Attachments/_Methodology/1.%20Enumeration/Other%20Services/22%20(SSH)/common%20keys/Attack%20scenario/{{notename}}-202605011742-1.png)
Entered the share using smbclient:
smbclient -U "" '//10.11.1.136/Bob Share/'
![unnamed_2daf10e0cb6f433e8a15d292c0f52e4d](docs/Attachments/_Methodology/1.%20Enumeration/Other%20Services/22%20(SSH)/common%20keys/Attack%20scenario/{{notename}}-202605011743.png)
...
![unnamed_1c3663f1e82c4b2dbb8c9b8644ab66b3](docs/Attachments/_Methodology/1.%20Enumeration/Other%20Services/22%20(SSH)/common%20keys/Attack%20scenario/{{notename}}-202605011743-1.png)

We can now see that rootfs has been succesfully added.
![unnamed_5de8e4a6d57346d9ab45bfacbd05080a](docs/Attachments/_Methodology/1.%20Enumeration/Other%20Services/22%20(SSH)/common%20keys/Attack%20scenario/{{notename}}-202605011743-2.png)
...
![[docs/Attachments/_Methodology/1. Enumeration/Other Services/22 (SSH)/common keys/Attack scenario/{{notename}}-202605011743-3.png]]

A backups folder, very interesting. Let's take a look. 
![[docs/Attachments/_Methodology/1. Enumeration/Other Services/22 (SSH)/common keys/Attack scenario/{{notename}}-202605011743-4.png]]

This might be valuable. Let's download them to our host and inspect further. 
![[docs/Attachments/_Methodology/1. Enumeration/Other Services/22 (SSH)/common keys/Attack scenario/{{notename}}-202605011743-5.png]]
...
![[docs/Attachments/_Methodology/1. Enumeration/Other Services/22 (SSH)/common keys/Attack scenario/{{notename}}-202605011743-6.png]]
...
![[docs/Attachments/_Methodology/1. Enumeration/Other Services/22 (SSH)/common keys/Attack scenario/{{notename}}-202605011743-7.png]]
