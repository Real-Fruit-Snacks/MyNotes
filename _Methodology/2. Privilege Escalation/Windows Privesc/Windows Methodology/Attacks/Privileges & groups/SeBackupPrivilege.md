...
expose %viper% x:
```
![unnamed_b9132e34f980417c9edaa36b22c4bca4](docs/Attachments/_Methodology/2.%20Privilege%20Escalation/Windows%20Privesc/Windows%20Methodology/Attacks/Privileges%20&%20groups/SeBackupPrivilege/{{notename}}-202605011742.png)